...
class StoreProductsScreen extends StatefulWidget {
  ...
  @override
  State<StoreProductsScreen> createState() => _ProductsScreenState();
}

class _ProductsScreenState extends State<StoreProductsScreen>
  ...
  void getCartItem2() async {
    ...
    db.getResturantOrderList().then((value) {
      List<RestaurantCartItem> tagObjs = value
          .map((tagJson) => RestaurantCartItem.fromJson(tagJson))
          .toList();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(
                ...
                style: Theme.of(
                  context,
                ).textTheme.bodyLarge!.copyWith(color: kMainTextColor),
              ),
              SizedBox(height: 10.0),
              Row(
                children: <Widget>[
                  Icon(Icons.location_on, color: kIconColor, size: 10),
                  SizedBox(width: 10.0),
                  Text(
        ...
        actions: [
          ...
          //   child: IconButton(
          //     icon: Icon(Icons.search, color: kHintColor),
          //     onPressed: () {
          //       setState(() {
          ...
          Padding(
            ...
            child: Stack(
              children: [
                IconButton(
                  icon: ImageIcon(AssetImage('images/icons/ic_cart blk.png')),
                  onPressed: () async {
                    ...
                    if (skip != null) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => oneViewCart()),
                      );
                    } else {
                      Navigator.pushNamed(context, PageRoutes.viewCart).then((
                        value,
                      ) {
      ...
      //             crossAxisAlignment: CrossAxisAlignment.start,
      //             children: <Widget>[
      //               Text(widget.pageTitle.toString(),
      //                   style: Theme.of(context)
      //                       .textTheme
      //                       .bodyLarge!
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: ListView.builder(
                                itemCount: subCategoryListApp.length,
                                itemBuilder: (context, index) {
                                  final subCategory = subCategoryListApp[index];
                                  final isSelected =
                                      index ==
                                      selectedIndex; // Replace `selectedIndex` with your logic for tracking the selected item
                                  ...
                                  return GestureDetector(
                                    onTap: () {
                                      ...
                                      tabController?.animateTo(index);
                                      hitTabSeriveList(subCategory.subcatId);
                                    },
                                    child: Container(
                                        ...
                                        border: Border(
                                          right: BorderSide(
                                            color: isSelected
                                                ? Colors.green
                                                : Colors.white,
                                            // Green for selected, grey for unselected
                                            width: 3,
                                          ),
                                        ),
                                      ),
                                      child: Column(
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: Image.network(
                                              '${imageBaseUrl}${subCategory.subcatImage ?? 'default_image.png'}',
                                              height: 45,
                                              fit: BoxFit.fitWidth,
                                              errorBuilder:
                                                  (context, error, stackTrace) {
                                                    // Display default image if network image fails to load
                                                    return Image.asset(
                                                      'assets/no_image.jpg',
                                                      height: 45,
                                                      fit: BoxFit.fitWidth,
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            Row(
                                                              children: [
                                                                Text(
                                                                  (productVarientList[index].data.length <=
                                                                              0 ||
                                                                          productVarientList[index].data[productVarientList[index].selectPos].strick_price <=
                                                                                    ...
                                                                                    ? (productVarientList[index].add_qnty ==
                                                                                          ...
                                                                                          ? Container(
                                                                                              ...
                                                                                              child: TextButton(
                                                                                                ...
                                                                                                onPressed: () {
                                                                                                  if (productVarientList[index].data.length ==
                                                                                                      1) {
                                                                                                    if (restrocart ==
                                                                                                        1) {
                                                                                                      print(
                                                                                                                          ...
                                                                                                                          Container(
                                                                                                                            child: Column(
                                                                                                                              children: [
                                                                                                                                      ...
                                                                                                                                      children: [
                                                                                                                                            ...
                                                                                                                                            children:
                                                                                                                                                ...
                                                                                                                                                >[
                                                                                                                                                  Column(
                                                                                                                                                    ...
                                                                                                                                                    // Aligns the children to the start (left) of the column
                                                                                                                                                    children: [
                                                                                                                                                      // First Column
                                                                                                                                                      Column(
                                                                                                                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                                                                                                        ...
                                                                                                                                        (productVarientList[index].data !=
                                                                                                                                            ...
                                                                                                                                            ? ListView.builder(
                                                                                                                                                ...
                                                                                                                                                // If it's inside another scrollable widget
                                                                                                                                                      ...
                                                                                                                                                      return Theme(
                                                                                                                                                        ...
                                                                                                                                                        child:
                                                                                                                                                            ...
                                                                                                                                                            >(
                                                                                                                                                              ...
                                                                                                                                                              value: entry,
                                                                                                                                                              groupValue: productVarientList[index].data[productVarientList[index].selectPos],
                                                                                                                                                              onChanged:
                                                                                                                                                                  (
                                                                                                                                                                    value,
                                                                                                                                                                  ) {
                                                                                                                                ...
                                                                                                                                //                           text: productVarientList[index].product_name,
                                                                                                                                //                           maxCharactersPerLine: 50,
                                                                                                                                //                           style: bottomNavigationTextStyle.copyWith(fontSize: 13.sp),
                                                                                                                                //                         ),
                                                                                                                                //                         // child: Text(productVarientList[index].product_name, style: bottomNavigationTextStyle.copyWith(fontSize: 15)),
                                                                                                                                //                       ),
                                                                                                                                //                     ],
    ...
    try {
      if (response.statusCode == 200) {
        ...
        if (jsonData['status'] == "1") {
          ...
          setState(() {
            for (SubCategoryList tagd in tagObjs) {
              if (tagd.istabacco.toString() != "1") {
                tabss.add(Tab(text: tagd.subcatName));
                toRemove.add(tagd);
              } else {}
            }
            setState(() {
            ...
            setState(() {
              productVarientList = [];
              // hitTabSeriveList(widget.subcat_id);
              // hitTabSeriveList(subCategoryListApp[0].subcatId,);
              hitTabSeriveList(subCategoryListApp[0].subcatId.toString());
            });
          ...
          setState(() {
            List<Tab> tabss = <Tab>[];
            tabss.add(Tab(text: category_name));
            subCategoryListApp.clear();
            tabs.clear();
            subCategoryListApp = [];
            tabs = tabss;
  ...
  void hitTabSeriveList(subCatId) async {
    ...
    var response = await http.post(
      myUri,
      body: {'subcat_id': subCatId.toString()},
    );
    try {
      if (response.statusCode == 200) {
    ...
    if (ui_type == "grocery" || ui_type == "Grocery" || ui_type == "1") {
      ...
      if (vendor_category_id == '18' || vendor_category_id == 18) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => StoresPage(category_name, vendor_category_id),
          ),
        );
      }
    }
...
Widget buildAddToCartButton() {
  return InkWell(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: Color(0xff0C831F).withOpacity(0.1),
        borderRadius: BorderRadius.circular(10.0),
        border: Border.all(width: 1, color: Color(0xff0C831F)),
      ),
      child: const Text(
        "Add",
        style: TextStyle(fontSize: 15, color: Color(0xff0C831F)),
      ),
    ),
  );
}
