...
class ItemsPage3 extends StatefulWidget {
  ...
  ItemsPage3(this.pageTitle, this.vendor_id, this.category_name,
...
class _ItemsPageState extends State<ItemsPage3> with SingleTickerProviderStateMixin {
