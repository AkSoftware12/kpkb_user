                          ...
                          bottom: PreferredSize(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                //           }));
                                //         }
                                //       }, onSelected: (ProductWithVarient value) {  },
                                //     ),
                                //   ),
                                // ),
                                TabBar(
                                  tabs: tabs,
                                  isScrollable: (subCategoryListApp != null && subCategoryListApp.length > 3) ? true : false,
                                  labelColor: kMainColor,
                                  unselectedLabelColor: kLightTextColor,
                                  controller: tabController,
                                  indicatorPadding: EdgeInsets.symmetric(horizontal: 8.0), // Adjust this value as needed
                                ),
                                                  ...
                                                  return GestureDetector(
                                                    ...
                                                    child: Stack(
                                                      children: <Widget>[
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: SplitTextWidget(
                                                                                ...
                                                                                style: bottomNavigationTextStyle.copyWith(fontSize: 13),
                                                                              ),
                                                                            ),
                                                                            SizedBox(height: 5),
                                                        ...
                                                        //                   30.0),
                                                        //     ),
                                                        //     child: (productVarientList[index].data != null && productVarientList[index].data.length > 0) ? DropdownButton<VarientList>(underline:
                                                        //                 Container(
                                                        //               height: 0.0,
                                                        //               color:
                                                        //               kCardBackgroundColor,
                                                        //             ),
                                                        //             value: productVarientList[index].data[productVarientList[index].selectPos],
                                                        //             items: productVarientList[index].data.map((e) {
                                                        //               return DropdownMenuItem<VarientList>(
                                                        //                 child: Text(
                                                        //                   '${e.quantity} ${e.unit}',
                                                        //                   style: Theme.of(context)
                                                        //                       .textTheme
                                                        ...
                                                        // Container(
                                                        //   height: 30,
                                                        //   child: (productVarientList[index].data != null && productVarientList[index].data.length > 0 &&
                                                        //       int.parse(
                                                        //           '${productVarientList[index]
                                                        ...
                                                        //                                           '${productVarientList[index]
                                                        //                                               .data[0]
                                                        //                                               .quantity} ${productVarientList[index]
                                                        //                                               .data[0]
                                                        //                                               .unit}',
                                                        //                                           style: Theme
                                                        //                                               .of(
                                                        ...
                                                        //                                           kCardBackgroundColor,
                                                        //                                         ),
                                                        //                                         value: productVarientList[index]
                                                        //                                             .data[productVarientList[index]
                                                        //                                             .selectPos],
                                                        //                                         items: productVarientList[index]
                                                        //                                             .data
                                                        //                                             .map((
                                                        //                                             e) {
