...
final ThemeData appTheme = ThemeData(
  ...
  textTheme: GoogleFonts.openSansTextTheme().copyWith(
    ...
    bodyLarge: TextStyle(fontWeight: FontWeight.bold, fontSize: 18.3),
    ...
    titleLarge: TextStyle(color: kLightTextColor, fontSize: 13.3),
    ...
    bodySmall: TextStyle(color: Colors.black, fontSize: 13.3),
    ...
    titleSmall: TextStyle(color: kLightTextColor, fontSize: 15.0),
  ),
);
...
final TextStyle inputTextStyle = TextStyle(fontSize: 20.0, color: Colors.black);
