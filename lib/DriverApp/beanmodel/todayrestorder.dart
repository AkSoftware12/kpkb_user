class TodayRestaurantOrder {
  ...
  factory TodayRestaurantOrder.fromJson(dynamic json) {
    ...
    if (jsData != null) {
      orderDetails = jsData
          .map((e) => TodayRestaurantOrderDetails.fromJson(e))
          .toList();
    }
