...
class _AcceptedBodyState extends State<AcceptedBody> {
  ...
  Future<void> hitService(String cartid, ProgressDialog pr) async {
    try {
      debugPrint("API URL ==> $delivery_out");
      debugPrint("Sending cart_id ==> $cartid");

      final response = await http.post(
        Uri.parse(delivery_out),
        body: {
          'cart_id': cartid,
        },
      );
      ...
      debugPrint("API STATUS ==> ${jsonData['status']}");
      ...
      if (response.statusCode == 200 && jsonData['status'].toString() == "1") {
        ...
        Fluttertoast.showToast(
          msg: jsonData['message'] ?? 'Order Picked Accepted',
        ...
        Fluttertoast.showToast(
          msg: jsonData['message'] ??
              'Accepted Some error occurred please contact with store.',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM,
          backgroundColor: Colors.black26,
          textColor: Colors.white,
      ...
      Fluttertoast.showToast(
        msg: 'Something went wrong Accepted',
        toastLength: Toast.LENGTH_SHORT,
        gravity: ToastGravity.BOTTOM,
        backgroundColor: Colors.black26,
        textColor: Colors.white,
