class CartItem{
  ...
  @override
  String toString() {
    return 'CartItem{store_name:$store_name,vendor_id:$vendor_id, _id: $_id, product_name: $product_name, qnty: $qnty, price: $price, unit: $unit, add_qnty: $add_qnty, varient_id: $varient_id, product_img: $product_img},gst: $gst},is_id: $is_id},is_pres: $is_pres,isBasket:$isBasket,addedBasket:$addedBasket}';
  }
}