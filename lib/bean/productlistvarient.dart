class ProductWithVarient{
  ...
  ProductWithVarient(
      this.product_id, this.product_name, this.products_image,  this.gst,this.add_qnty,this.is_pres,this.is_id,this.isbasket,this.is_veg,this.data,this.selectPos,this.str1,this.str2,this.category_id,this.category_name,this.subcat_id);
  ...
  factory ProductWithVarient.fromJson(dynamic json){
    ...
    return ProductWithVarient(json['product_id'], json['product_name'], json['gst'], json['products_image'], 0, json['is_pres'], json['is_id'],json['isbasket'],json['is_veg'],_tags,0,json['str1'],json['str2'],json['category_id'],json['category_name'],json["subcat_id"]);
  }

  @override
  String toString() {
    return 'ProductWithVarient{product_id: $product_id, product_name: $product_name, products_image: $products_image, gst: $gst, add_qnty: $add_qnty,is_press: $is_pres,is_id: $is_id,isbasket:$is_veg ,is_veg:$isbasket ,data: $data, str1:$str1,str2:$str2,category_id:$category_id,category_name:$category_name}';
  }
}
