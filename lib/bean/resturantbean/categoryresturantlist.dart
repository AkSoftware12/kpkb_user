...
class CategoryResturant {
  ...
  CategoryResturant(this.resturant_cat_id, this.cat_name, this.product_id,
      this.product_name, this.product_image, this.is_veg, this.description, this.variant, this.addons);
  factory CategoryResturant.fromJson(dynamic json){
    ...
    return CategoryResturant(json['resturant_cat_id'], json['cat_name'], json['product_id'], json['product_name'], json['product_image'],json['is_veg'], json['description'], _tags, _tags1);
  }

  @override
  String toString() {
    return '{resturant_cat_id: $resturant_cat_id, cat_name: $cat_name, product_id: $product_id, product_name: $product_name, product_image: $product_image, is_veg: $is_veg, description: $description, variant: $variant, addons: $addons}';
  }
